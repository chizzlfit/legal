...
- access, tamper with, or use non-public areas of the Service, our systems, or those of our providers;
- probe, scan, or test the vulnerability of any system or network, or breach or circumvent any security, authentication, entitlement-verification, or usage-limit measure;
- access, hack, intrude upon, disrupt, overload, or interfere with the Service or its infrastructure, or introduce malware or malicious code;
- make automated, excessive, or abusive requests to the Service or its AI features, or take any action intended to inflate our costs or degrade the Service;
- reverse engineer, decompile, disassemble, scrape, or attempt to derive source code, except to the extent this restriction is prohibited by law;
- use bots, automated means, or scripts to access or extract data from the Service;
- resell, sublicense, or commercially exploit the Service without our written consent;
- infringe intellectual-property or privacy rights, or upload content you lack the right to submit; or
...
## 6. Reservation of Rights and Legal Remedies
